...
path = '/home/ava/Dropbox (ASU)/temp/Metabackbone/structure_files/six_helix_oxdna_file/modified/trimmed_staples/1512_bp'
file_dir = os.path.join(path,'1512_bp')
sim_path = '/home/ava/Dropbox (ASU)/temp/Metabackbone/metabackbone/notebooks/Simulations/simulations/trimmed_staples/1512_bp'
