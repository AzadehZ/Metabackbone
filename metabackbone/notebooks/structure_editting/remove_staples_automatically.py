...
def dna_structures(dna, staples_in_sphere):
    ...
    for strand in dna.strands:
        ...
        for base in strand:
            ...
            if base.uid not in staples_in_sphere:
                bases_out_sphere.append(base_info)
            else:
                bases_in_sphere.append(base_info)

        if bases_out_sphere:
            new_strands = strand_from_info(bases_out_sphere)
    ...
    while backup_sphere_list:
        ...
        mixed_list = []
        for staple in backup_sphere_list:
            mixed_list.append(staple)
...
new_structures = dna_structures(dna, staples_in_sphere)